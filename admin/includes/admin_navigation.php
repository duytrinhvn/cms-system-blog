        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#posts_dropdown"><i class="fas fa-paste"></i> Posts <i class="fa fa-fw fa-caret-down"></i></a>
                    ...
                    <li>
                        <a href="profile.php"><i class="far fa-clipboard"></i> Profile</a>
                    </li>

                    <li>
                        <a href="categories.php"><i class="fas fa-align-justify"></i> Categories</a>
                    </li>
